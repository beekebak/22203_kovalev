...
TEST_F(MatchTest, FirstPlayerWinsByDefault) {
    Match<int, int> match(mock_player_one, mock_player_two, mock_dealer, std::move(mock_logger), MatchType::kAutomatic, 1, 2);
...
TEST_F(MatchTest, GameQuit){
    ...
    Match<int, int> match(mock_player_one, mock_player_two, mock_dealer, std::move(mock_logger), MatchType::kManual, 1, 2, stream);
